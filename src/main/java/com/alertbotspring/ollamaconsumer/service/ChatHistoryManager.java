...
public class ChatHistoryManager {
    ...
    private static final String SYSTEM_PROMPT = "Eres un motor de extracción de datos. Tu única tarea es analizar el mensaje del usuario y devolver SIEMPRE un único objeto JSON válido.\n" +
            "1.  Si el mensaje del usuario es una solicitud de producto devuelve el JSON de extracción (campos: product, level (clasifica en beginner, intermediate, expert), price_max, duration_max, language). Si hay un campo no especificado complétalo con \"no especificado\"" +
